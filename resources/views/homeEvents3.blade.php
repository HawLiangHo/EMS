...
@if($event->publish_status=="Published" && $event->event_status=="Closed")
    ...
    <div class="card" id="{{ 'homeEvents' . $event->id}}">
        <div class="card-body text-left" style="padding: 0.85rem;">
            ...
            <div>
                ...
                <label class="ms-0" style="margin-left: 0; color:rgb(132, 132, 132);">By {{ $event->createdBy->username }}</label>            </div>
        </div>
    </div>
</div>
@endif
