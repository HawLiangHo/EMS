            ...
            <div class="col-md-4" style="margin-bottom: 20px;">
                <div class="card" id="{{ 'homeEvents' . $events->id}}">
                    <div class="card-body text-left" style="padding: 0.85rem;">
                        ...
                        <div>
                            <h4 class="m-0">
                                <a style="color: rgb(48, 48, 48); font-weight: bold;">{{ $events->title }}</a>
                            </h3>
                            <label class="ms-0" style="margin-left: 0; color:orange;">{{ $events->start_date }}, {{ $events->start_time }}</label><br>
