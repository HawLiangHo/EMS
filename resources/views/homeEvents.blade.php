    ...
    <div class="card" id="{{ 'homeEvents' . $event->id}}">
        <div class="card-body text-left" style="padding: 0.85rem;">
            ...
            <div>
                ...
                <label class="ms-0" style="margin-left: 0; color:orange;">{{ $event->start_date }}, {{ $event->start_time }}</label><br>
                <label class="ms-0" style="margin-left: 0; color:rgb(132, 132, 132);">{{ $event->tags }}</label><br>
                <label class="ms-0" style="margin-left: 0; color:rgb(15, 15, 15);">{{ $event->user->username }}</label>
            </div>
        </div>
    </div>
</div>
